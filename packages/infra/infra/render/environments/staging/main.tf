...
module "environment" {
  ...
  environment_name = "__YURT_PROJECT_NAME__ Staging"
  # Minted by infra/render/project — apply that root module first, then replace
  # this placeholder with the staging ID from its environment_ids output
  ...
  database_name = "__YURT_PROJECT_SLUG_UNDERSCORE___staging_db"
  database_user = "__YURT_PROJECT_SLUG_UNDERSCORE___staging_db_user"
