# Adopts the production tenant's default connections and sets their app
# enablement to the intended state:
#   - Username-Password-Authentication -> Production SPA only (the login path)
